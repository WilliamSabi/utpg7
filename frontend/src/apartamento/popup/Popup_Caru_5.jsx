...
//Imagenes
import dept_1 from '../../assets/images/apartamentos/dept_5.jpg';

import Caro from '../carrusel_popup/Caro_popup_5'
            ...
            >
              <div className="row modal-card_popup">
                ...
                <Offcanvas.Header onClick={handleModalClose} closeButton style={{height: '20px'}}>
                        <h3 className="titu_nombre" >Butique Norte</h3>
                        <div></div>
                    </Offcanvas.Header>
                    <hr/>
                  <p className="info_persona">Sector Sur, Cali Área 237 m² </p>
                  <p className="info_persona">Habitación: 3 - Baño: 3 - Estracto: 6 </p>
