...
//Imagenes
import dept_1 from '../../assets/images/apartamentos/dept_8.jpg';

import Caro from '../carrusel_popup/Caro_popup_8'
    ...
    return (
        ...
        <div className="App">
          ...
          >
            ...
            >
              <div className="row modal-card_popup_8">
                ...
                <Offcanvas.Header onClick={handleModalClose} closeButton style={{height: '20px'}}>
                        <h3 className="titu_nombre" >Loma de la Cruz</h3>
                        <div></div>
                    </Offcanvas.Header>
                    <hr/>
                  <p className="info_persona">Sector Nororiente, Pasto - Área 90 m² </p>
                  <p className="info_persona">Habitación: 5 - Baño: 4 - Estracto: 7 </p>
